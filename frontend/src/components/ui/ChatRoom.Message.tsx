...
const chatgptImage =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4_r3Acc36eObyIPdKCgOLm2H-vEKUtvcns0GyGiR7FtQcBYMv";
...
export const ChatRoomMessage = ({ message, user }: PropTypes) => {
  return (
